    ...
    <>
      <div className="bg-black">
        <div className="fixed top-0 left-0 right-0 z-50 w-full">
          <nav className="w-full border-b border-white/20 bg-black py-4 px-5 transition-all duration-300 relative">
        ...
        <div className="lg:block hidden p-4 bg-black border-t border-white/20 pt-[150px] ">
